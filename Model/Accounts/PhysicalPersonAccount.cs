...
namespace Bank.DAL.Accounts
{
    ...
    public class PhysicalPersonAccount
    {
        ...
        public PhysicalPersonAccount(int clientId, Currencies currency, decimal amount, decimal rate = 0)
        {
            ClientId = clientId;
            Currency = currency;
            Amount = amount;
        ...
        /// <param name="rate">Ставка в процентах.</param>
        public PhysicalPersonAccount(int clientId, Currencies currency, decimal amount, PhysicalPersonClient client, decimal rate = 0)
        {
            ClientId = clientId;
            Currency = currency;
            Amount = amount;
